...
const ICONS   = [<Pets />, <Person />, <MedicalServices />, <Park />, <CheckCircle />];
...
const Connector = styled(StepConnector)(() => ({
  ...
  [`&.${stepConnectorClasses.completed} .${stepConnectorClasses.line}`]: { background: `linear-gradient(90deg, #1D6258, ${PRIMARY})` },
}));
...
const VetStepper = ({ activeStep, onStepClick }) => (
    ...
    {STEPS.map((label, i) => (
      ...
      >
        <StepLabel StepIconComponent={StepIcon}>
          <Typography sx={{
            fontFamily: FONT, fontSize: "0.73rem",
            fontWeight: activeStep === i ? 800 : 500,
            color: activeStep === i ? PRIMARY : i < activeStep ? "#1D6258" : "text.secondary",
